...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/project1.jpg" class="teaser img-fluid z-depth-1">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author"><strong>Group Leader</strong>, Research Project, Advisor: PhD candidate. Rui Jin (TU Dortmund, Germany)</div>
